...
/**
 * Convert a 2-byte ASCII string to a short integer
 * 
 * @param ascii The ASCII string to convert.
 * @param processorCompatibility This is the processor type.  It can be either INTEL or MOTOROLA.  This
 * is used to determine if the bytes need to be swapped.
 * 
 * @return a short.
 */
...
/**
 * It takes a pointer to a buffer, an index into that buffer, a 16-bit value, and a processor
 * compatibility flag.  It then writes the 16-bit value into the buffer at the specified index, in
 * big-endian or little-endian format, depending on the processor compatibility flag
 * 
 * @param trame the array of bytes to write to
 * @param i_index the index of the array where the data is to be written
 * @param mot the value to be written
 * @param processorCompatibility This is the endianness of the processor.
 * 
 * @return Nothing.
 */
void
...
/**
 * It takes a bunch of parameters, and returns a string of bytes that can be sent to a Modbus device
 * 
 * @param address the address of the device you're trying to communicate with
 * @param codeFunction 1 for read coils, 3 for read registers, 5 for write coil, 6 for write register
 * @param startAddress the address of the first register to read
 * @param nbParams number of parameters to read
 * @param trame the array of bytes that will be sent to the device
 * @param processorCompatibility INTEL or MOTOROLA
 * 
...
===============================================================*/
/**
 * It takes a short value and writes it to a Modbus register
 * 
 * @param address the address of the device you're talking to
 * @param codeFunction 0x10
 * @param startAddress the address of the first register to write to
 * @param value the value to be written to the register
 * @param trame the buffer to write the Modbus frame to
 * @param processorCompatibility INTEL or MOTOROLA
 * 
 * @return The length of the trame.
 */
...
===============================================================*/
/**
 * It takes a Modbus RTU frame, parses it, and returns the data in the frame
 * 
 * @param trame the raw data received from the serial port
 * @param lengthTrameReceive the length of the received message
 * @param values the array of values that you want to read
 * @param nbValues the number of values returned
 * @param address the address of the device
 * @param codeFunction The function code of the Modbus message.
 * @param processorCompatibility INTEL or MOTOROLA
 * 

...
/**
 * It sends a string to a serial port and then receives a string from the serial port
 * 
 * @param hPort the handle to the serial port
 * @param i_iTimeOut Timeout in milliseconds
 * @param i_sTrameIn The string to send to the serial port
 * @param i_lengthIn the length of the data to be sent
 * @param i_sTrameOut the buffer to store the received data
 * @param i_lengthOut the length of the response
 * 
 * @return an ErrorComm enum.
 */
